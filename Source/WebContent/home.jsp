	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner" role="listbox">
			...
			<div class="carousel-item"
				style="background-image: url('https://www.benesserecorpomente.it/wp-content/uploads/2016/03/verdure_fresche.jpg')">
				...
				<div class="carousel-caption d-none d-md-block">
					...
					<p style="color: #000000">
						<strong>Ci occupiamo personalmente dei nostri prodotti
							sin dall'origine per offrirvi prodotti di altà qualità.</strong>
					</p>
				</div>
			</div>
		</div>
	...
	<div class="row" id="img">
		...
		<%
            ...
            if (products != null && products.size() != 0) {
				...
				while (it.hasNext()) 	array.add((ProductBean) it.next());
				
				while(arrayVetrina.size() < 4){
